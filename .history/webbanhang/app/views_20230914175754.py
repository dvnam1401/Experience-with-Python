...
def category(request):
    ...
    active__category = request.GET.get('category', '')
    if active__category:
        product = Product.objects.filter(category_slug=active__category)
    context = {'category': categories, 'product': product,
               'active_category': active__category}
...
def home(request):
    ...
    context = {'products': products, 'cartItems': cartItems,
               "user_not_login": user_not_login, "user_login": user_login, 'category': categories, 'active_category': active_category}
